...
function add2(a: number, b:number): number { // here if we do not specify the return type of the function there will be an error in the implementation of the function
    return a + b;
